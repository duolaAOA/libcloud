...
from libcloud.compute.drivers.cvm import CVMDriver
from libcloud.compute.types import NodeState, StorageVolumeState
from libcloud.test import MockHttp, LibcloudTestCase
from libcloud.test.file_fixtures import ComputeFileFixtures
from libcloud.test.secrets import CVM_PARAMS
from libcloud.utils.py3 import httplib


class CVMDriverTestCase(LibcloudTestCase):
    region = 'ap-beijing'
    zone = 'cn-qingdao-b'
    image_id = 'ubuntu1404_64_20G_aliaegis_20150325.vhd'

    def setUp(self):
        CVMMockHttp.test = self
        CVMDriver.connectionCls.conn_class = CVMMockHttp
        CVMMockHttp.use_param = 'Action'
        CVMMockHttp.type = None

        self.driver = CVMDriver(*CVM_PARAMS, region=self.region)
        self.fake_size = NodeSize('cvm.t1.small', 'cvm t1 small', None, None,
    ...
    #     CVMMockHttp.type = 'list_nodes_ex_node_ids'
    #     nodes = self.driver.list_nodes(
    #         ex_node_ids=['i-28n7dkvov', 'not-existed-id'])
    #     self.assertIsNotNone(nodes)

    # def test_list_nodes_with_ex_filters(self):
    #     CVMMockHttp.type = 'list_nodes_ex_filters'
    ...
    #     CVMMockHttp.type = 'create_node_with_data'
    ...
    #     size = sizes[0]
    #     self.assertEqual('cvm.t1.xsmall', size.id)
    #     self.assertEqual('cvm.t1.xsmall', size.name)
    #     self.assertEqual(0.5, size.ram)
    #     self.assertEqual(1, size.extra['cpu_core_count'])
    #     self.assertEqual('cvm.t1', size.extra['instance_type_family'])
    #     size = sizes[1]
    #     self.assertEqual('cvm.s2.small', size.id)
    #     self.assertEqual('cvm.s2.small', size.name)
    ...
    #     CVMMockHttp.type = 'list_volume_snapshots_ex_snapshot_ids'
    ...
    #     CVMMockHttp.type = 'list_volume_snapshots_ex_filters'
    #     ex_filters = {'InstanceId': self.fake_node.id}
    #     self.driver.list_volume_snapshots(self.fake_volume,
    #                                       ex_filters=ex_filters)

    # def test_create_volume(self):
    #     CVMMockHttp.type = 'create_volume'
    #     self.volume_size = 1
    #     self.volume_name = 'fake-volume-name'
    #     self.description = 'fake-description'
    #     self.disk_category = 'system'
    #     self.client_token = 'client_token'
    #     volume = self.driver.create_volume(self.volume_size,
    #                                        self.volume_name,
    ...
    #     self.assertRaises(AttributeError, self.driver.create_volume, 1,
    #                       'fake-volume-name')

    # def test_create_volume_snapshot(self):
    #     CVMMockHttp.type = 'create_volume_snapshot'
    ...
    #     CVMMockHttp.type = 'detach_volume'
    #     result = self.driver.detach_volume(self.fake_volume)
    #     self.assertTrue(result)
    ...
    #     CVMMockHttp.type = 'destroy_volume'
    ...
    #     CVMMockHttp.type = 'destroy_volume_state'
    #     self.assertRaises(LibcloudError, self.driver.destroy_volume,
    #                       self.fake_volume)
    ...
    def test_list_images(self):
        ...
        self.assertEqual(except_image, image)

    def test_list_images_with_ex_image_ids(self):
        CVMMockHttp.type = 'list_images_ex_image_ids'
...
#         CVMMockHttp.type = 'copy_image_same_region'
...
#         CVMMockHttp.type = 'list_sgs_filters'
#         self.vpc_id = 'vpc1'
...
class CVMMockHttp(MockHttp):
    fixtures = ComputeFileFixtures('cvm')
    ...
    def _create_public_ip_AllocatePublicIpAddress(self, method, url, body,
                                                  headers):
